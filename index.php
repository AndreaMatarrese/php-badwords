...
<body>
    ...
    <div class="main row row-cols-2 justify-content-center">
        <div class="original col-5">
            ...
            <?= 'Il testo è lungo' . ' ' . strlen($original_text) . ' ' . 'caratteri'?>
            <form action="" method="get">
                <label for="censure">Inserisci la parola che ritieni offensiva</label>
        ...
        <div class="corrected col-5">
            ...
            <?= 'Il testo è lungo' . ' ' . strlen($corrected_text) . ' ' . 'caratteri'?>
        </div>
    </div>
</body>
</html>